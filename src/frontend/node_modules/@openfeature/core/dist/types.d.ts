...
declare const TelemetryAttribute: {
     ...
     */
    readonly VARIANT: "feature_flag.variant";
    /**
     ...
     */
    readonly ERROR_MESSAGE: "feature_flag.evaluation.error.message";
    /**
     ...
     */
    readonly REASON: "feature_flag.evaluation.reason";
    /**
     * Describes a class of error the operation ended with.
     *
     * - type: `string`
     ...
     * - example: `flag_not_found`
     */
    readonly PROVIDER: "feature_flag.provider_name";
    /**
 ...
 * @see https://opentelemetry.io/docs/specs/semconv/feature-flags/feature-flags-logs/
 */
declare const TelemetryEvaluationData: {
    /**
...
export { ClientProviderEvents as AllProviderEvents, ClientProviderStatus as AllProviderStatus, type AnyProviderEvent, type BaseHook, type BeforeHookContext, type ClientMetadata, ClientProviderEvents, ClientProviderStatus, type CommonEventDetails, type CommonProvider, type ConfigChangeEvent, DefaultLogger, ErrorCode, type ErrorEvent, type EvaluationContext, type EvaluationContextValue, type EvaluationDetails, type EvaluationLifeCycle, type EventContext, type EventDetails, type EventHandler, type EventMetadata, type EventOptions, type Eventing, type FlagMetadata, FlagNotFoundError, type FlagValue, type FlagValueType, GeneralError, GenericEventEmitter, type HookContext, type HookHints, InvalidContextError, type JsonArray, type JsonObject, type JsonValue, LOG_LEVELS, type Logger, type ManageContext, type ManageLogger, type Metadata, type NotChangeEvents, OpenFeatureCommonAPI, OpenFeatureError, type Paradigm, ParseError, type PrimitiveValue, type ProviderEventEmitter, ProviderFatalError, type ProviderMetadata, ProviderNotReadyError, ProviderWrapper, type ReadyEvent, type ReconcilingEvent, type ResolutionDetails, type ResolutionReason, SafeLogger, ServerProviderEvents, ServerProviderStatus, type StaleEvent, StandardResolutionReasons, TargetingKeyMissingError, TelemetryAttribute, TelemetryEvaluationData, TelemetryFlagMetadata, type TrackingEventDetails, type TrackingEventValue, TypeMismatchError, createEvaluationEvent, instantiateErrorByErrorCode, isObject, isString, objectOrUndefined, statusMatchesEvent, stringOrUndefined };
